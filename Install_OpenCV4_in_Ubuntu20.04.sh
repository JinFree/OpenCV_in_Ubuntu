...
sudo apt install gcc make cmake curl vim git python-dev python3-dev \
 python3-pip libgflags-dev v4l-utils pyqt5-dev-tools build-essential \
...
sudo apt-get install -y \
 ...
 libgstreamer-plugins-base1.0-dev  \
 libgstreamer-plugins-bad1.0-dev qtbase5-dev mesa-utils libgl1-mesa-dri \
 libatlas-base-dev gfortran libeigen3-dev  \
 python3-dev python-numpy python3-numpy python3-pip python3-matplotlib
