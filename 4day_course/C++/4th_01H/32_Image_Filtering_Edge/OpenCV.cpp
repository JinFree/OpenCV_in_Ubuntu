...
int main(void) {
	...
	Mat roadColor_Prewitt, roadColor_Sobel, roadColor_Scharr, roadColor_LaplacianCV, roadColor_LaplacianFilter, roadColor_LoG;
	
	imageEdgePrewitt(roadColor, roadColor_Prewitt);
	imageEdgeSobel(roadColor, roadColor_Sobel);
    imageEdgeScharr(roadColor, roadColor_Scharr);
    imageEdgeLaplacianCV(roadColor, roadColor_LaplacianCV);
    imageEdgeLaplacianFilter2D(roadColor, roadColor_LaplacianFilter);
    imageEdgeLoG(roadColor, roadColor_LoG);
