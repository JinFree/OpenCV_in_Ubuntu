...
int main(void) {
	...
	Mat roadThresh;
	imageThreshold(roadGray, roadThresh, 128, 255);
	imageShow("roadThresh", roadThresh);
	float kernel_[] = {1, 1, 1, 1, 1, 1, 1, 1, 1};
	Mat kernel(3, 3, CV_32F,kernel_);
	Mat roadGray_Dilation, roadGray_Erosion, roadGray_Opening, roadGray_Closing, roadGray_Gradient;
	imageDilation(roadThresh, roadGray_Dilation, kernel, 1);
	imageErosion(roadThresh, roadGray_Erosion, kernel, 1);
	imageOpening(roadThresh, roadGray_Opening, kernel, 1);
	imageClosing(roadThresh, roadGray_Closing, kernel, 1);
	imageMorphologicalGradient(roadThresh, roadGray_Gradient);
