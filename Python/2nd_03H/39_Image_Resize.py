...
roadColor_Resize_01 = imageResize(roadColor, (int(width*0.5), int(height*0.5)))
roadColor_Resize_02 = imageResize(roadColor, fx=0.5, fy=0.5)
print(roadColor_Resize_01.shape[:2]) 
print(roadColor_Resize_02.shape[:2]) 

roadColor_Resize_03 = imageResize(roadColor, (int(width*2), int(height*2)))
roadColor_Resize_04 = imageResize(roadColor, fx=2, fy=2)
